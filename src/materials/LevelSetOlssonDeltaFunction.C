...
#include "LevelSetOlssonDeltaFunction.h"

registerMooseObject("MalamuteApp", LevelSetOlssonDeltaFunction);

InputParameters
LevelSetOlssonDeltaFunction::validParams()
{
...
LevelSetOlssonDeltaFunction::LevelSetOlssonDeltaFunction(const InputParameters & parameters)
...
void
LevelSetOlssonDeltaFunction::computeQpProperties()
{
  _delta_function[_qp] =
