 ...
 * for this.
 */
class MeltPoolMomentumTimeDerivative : public TimeDerivative
{
public:
  static InputParameters validParams();

  MeltPoolMomentumTimeDerivative(const InputParameters & parameters);

  virtual ~MeltPoolMomentumTimeDerivative() {}
